...
public class HttpConfig {
    public static <T,P> T sendPostRequest(String uri, Class<T> cClass, P obj) throws RequestException {
        try {
            HttpRequest httpRequest = HttpRequest.
                    newBuilder(URI.create("http://localhost:8080" + uri)).
                    header("Content-Type", "application/json").
                    POST(HttpRequest.BodyPublishers.ofString(ObjectMapperConfigs.getObjectMapper().writeValueAsString(obj))).
                    build();
    ...
    public static <T,P> T sendGetRequest(String uri, Class<T> cClass) throws RequestException {
        try {
            HttpRequest httpRequest = HttpRequest.
                    newBuilder(URI.create("http://localhost:8080" + uri)).
                    header("Content-Type", "application/json").
